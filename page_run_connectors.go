...
func RunConnectorsPage(t *template.Template, am AccessManager, defaultTimezone *time.Location) func(w http.ResponseWriter, r *http.Request) {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		for _, virtualHost := range am.AvailableSites() {
			if virtualHost == "" || virtualHost == "d3rPsL77Wh.com" || virtualHost == "keyspaces" || virtualHost == "psc-au.tai.io" || virtualHost == "localhost" || virtualHost == "sis-au.appspot.com" || virtualHost == "bN79aft4SD.com" || virtualHost == "CJciEHHYss.com" || virtualHost == "YWbgsyjzcM.com" || virtualHost == "dev.montebo.com" {
				continue
			}
